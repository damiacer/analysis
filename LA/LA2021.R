...
#la <- read_excel("MERP_20210707_39.xlsx", na = "NA")
...
la = apply_labels(la,
                    ...
                    Poids = "Poids",
                    IMC = "IMC",
                    entreerea = "Date Entree en Rea",
                    diagSDRA = "Date Diagnostic de SDRA",
                    IOT = "Date IOT",
                    inclusion = "Date inclusion",
                    dela_reainclusion = "Delai Entree Rea-inclusion",
                    delai_IOTinclusion = "Delai IOT-inclusion",
                    delai_SDRAinclusion = "Delai Dg SDRA-inclusion",
                    seancesDV = "Nb seances DV total",
                    seancesDV_avantinclusion01 = "Seances de DV avant l'inclusion",
                    seancesDV_avantinclusion = "Si DV avant l'inclusion Nbr de seances",
                    etiologieSDRApulmonaire = "Etiologie SDRA pulmunaire",
                    covid01 = "Covid 19+",
                    delai_covidsympt_inclusion = "Delai Sympt. COVID/Inclusion",
                    delai_COVID_Inclusion = "Delai Df COVID/Inclusion",
                    delai_COVID_Inclusion7j = "Delai Dg COVID/Inclusion -7j",
                    delai_COVID_Inclusion7j14j = "Delai Dg COVID/Inclusion 7-14j",
                    delai_COVID_Inclusion14j = "Delai dg COVID/Inclusion >14j",
                    ...
                    FDR_SDRA_pancreatiteaigue = "FDR SDRA Pancreatite aigue",
                    FDR_SDRA_peritonite = "FDR SDRA Peritoneite",
                    FDR_SDRA_ischemiedigestive = "FDR SDRA Ischemie digestive",
                    FDR_SDRA_traumatisegrave = "FDR SDRA Traumatise grave",
                    ...
                    dureeMERPplusMRA_min = "Duree MERP+MRA (min)",
                    dureeMERPplusMRA_inf10min = "Duree MERP+MRA - de 10 min",
                    dureeMERPplusMRA_10_15min = "Duree MERP+MRA [10-15] min",
                    dureeMERPplusMRA_plus15min = "Duree MERP+MRA + de 15 min",
                    ...
                    Vrec_VteaPEEP15 = "Vrec (Calcule avec le Vte ? PEEP 15)",
                    ...
                    Delta_P_F_neg = "Delta P/F Negatif",
                    T0_apresMERPplusMRA_Vt_mlkg = "T0 apr?s MERP+MRA Vt (ml/kg)",
                    T0_apresMERPplusMRA_Vt_ml = "T0 apr?s MERP+MRA Soit Vt (ml)",
                    T0_apresMERPplusMRA_FRcpm = "T0 apr?s MERP+MRA FR (cpm)",
                    T0_apresMERPplusMRA_CompliancemlcmH2O = "T0 apr?s MERP+MRA Compliance (ml/cmH2O)",
                    T0_apresMERPplusMRA_Compliance_inf20mlcmH2O = "T0 apr?s MERP+MRA Compliance < 20ml/cmH2O",
                    T0_apresMERPplusMRA_Compliance_20_40mlcmH2O = "T0 apr?s MERP+MRA Compliance [20-40]ml/cmH2O",
                    T0_apresMERPplusMRA_Compliance_sup40mlcmH2O = "T0 apr?s MERP+MRA Compliance > 40ml/cmH2O",
                    T0_apresMERPplusMRA_FiO2 = "T0 apr?s MERP+MRA FiO2",
                    T0_apresMERPplusMRA_Ventmin_Lmin = "T0 apr?s MERP+MRA Vent min (L/min)",
                    T0_apresMERPplusMRA_debit_Lmin = "T0 apr?s MERP+MRA Debit (L/min)",
                    T0_apresMERPplusMRA_TpsInpsi_sec = "T0 apr?s MERP+MRA Tps inpsi (sec)",
                    T0_apresMERPplusMRA_I_E = "T0 apr?s MERP+MRA I/E",
                    T0_apresMERPplusMRA_Pplat_cmH2O = "T0 apr?s MERP+MRA Pplat (cmH2O)",
                    T0_apresMERPplusMRA_Pplat_inf20cmH2O = "T0 apr?s MERP+MRA Pplat <20 cmH2O",
                    T0_apresMERPplusMRA_Pplat_20_25_cmH2O = "T0 apr?s MERP+MRA Pplat [20-25] cmH2O",
                    T0_apresMERPplusMRA_Pplat_25_30_cmH2O = "T0 apr?s MERP+MRA Pplat [25-30] cmH2O",
                    T0_apresMERPplusMRA_Pplatsup30cmH2O = "T0 apr?s MERP+MRA Pplat >30 cmH2O",
                    T0_apresMERPplusMRA_PEEP_cmH2O = "T0 apr?s MERP+MRA PEEP (cmH2O)",
                    T0_apresMERPplusMRA_PEEP_5_10_cmH2O = "T0 apr?s MERP+MRA PEEP [5-10] cmH2O",
                    T0_apresMERPplusMRA_PEEP_10_15cmH2O = "T0 apr?s MERP+MRA PEEP [10-15] cmH2O",
                    T0_apresMERPplusMRA_PEEPsup15cmH2O = "T0 apr?s MERP+MRA PEEP > 15 cmH2O",
                    T0_apresMERPplusMRA_PmotricecmH2O = "T0 apr?s MERP+MRA Pmotrice (cmH2O)",
                    T0_apresMERPplusMRA_Pmotrice_inf10cmH2O = "T0 apr?s MERP+MRA Pmotrice <10 cmH2O",
                    T0_apresMERPplusMRA_Pmotrice_10_15cmH2O = "T0 apr?s MERP+MRA Pmotrice [10-15] cmH2O",
                    T0_apresMERPplusMRA_Pmotrice_sup15cmH2O = "T0 apr?s MERP+MRA Pmotrice >15 cmH2O",
                    apresGdS15_postMRA_Vt_mlkg = "Apr?s GdS 15' post-MRA Vt (ml/kg)",
                    apresGdS15_postMRA_SoitVt_ml = "Apr?s GdS 15' post-MRA Soit Vt (ml)",
                    apresGdS15_postMRA_FR_cpm = "Apr?s GdS 15' post-MRA FR (cpm)",
                    apresGdS15_postMRA_Compliance_mlcmH2O = "Apr?s GdS 15' post-MRA Compliance (ml/cmH2O)",
                    apresGdS15_postMRA_Compliance_inf20mlcmH2O = "Apr?s GdS 15' post-MRA Compliance < 20ml/cmH2O",
                    apresGdS15_postMRA_Compliance_20_40mlcmH2O = "Apr?s GdS 15' post-MRA Compliance [20-40]ml/cmH2O",
                    apresGdS15_postMRA_Compliance_sup40mlcmH2O = "Apr?s GdS 15' post-MRA Compliance > 40ml/cmH2O",
                    apresGdS15_postMRA_FiO2 = "Apr?s GdS 15' post-MRA FiO2",
                    apresGdS15_postMRA_Ventmin_Lmin = "Apr?s GdS 15' post-MRA Vent min (L/min)",
                    apresGdS15_postMRA_debit_Lmin = "Apr?s GdS 15' post-MRA Debit (L/min)",
                    apresGdS15_postMRA_TpsInpsi_sec = "Apr?s GdS 15' post-MRA Tps inpsi (sec)",
                    apresGdS15_postMRA_I_E = "Apr?s GdS 15' post-MRA I/E",
                    apresGdS15_postMRA_PplatcmH2O = "Apr?s GdS 15' post-MRA Pplat (cmH2O)",
                    apresGdS15_postMRA_Pplat_inf20cmH2O = "Apr?s GdS 15' post-MRA Pplat <20 cmH2O",
                    apresGdS15_postMRA_Pplat_20_25cmH2O = "Apr?s GdS 15' post-MRA Pplat [20-25] cmH2O",
                    apresGdS15_postMRA_Pplat_25_30cmH2O = "Apr?s GdS 15' post-MRA Pplat [25-30] cmH2O",
                    apresGdS15_postMRA_Pplat_sup30cmH2O = "Apr?s GdS 15' post-MRA  Pplat >30 cmH2O",
                    apresGdS15_postMRA_PEEP_cmH2O = "Apr?s GdS 15' post-MRA PEEP (cmH2O)",
                    apresGdS15_postMRA_PEEP_5_10cmH2O = "Apr?s GdS 15' post-MRA PEEP [5-10] cmH2O",
                    apresGdS15_postMRA_PEEP_10_15cmH2O = "Apr?s GdS 15' post-MRA PEEP [10-15] cmH2O",
                    apresGdS15_postMRA_PEEP_sup15cmH2O = "Apr?s GdS 15' post-MRA PEEP > 15 cmH2O",
                    apresGdS15_postMRA_PmotricecmH2O = "Apr?s GdS 15' post-MRA Pmotrice (cmH2O)",
                    apresGdS15_postMRA_Pmotrice_inf10cmH2O = "Apr?s GdS 15' post-MRA Pmotrice <10 cmH2O",
                    apresGdS15_postMRA_Pmotrice_10_15cmH2O = "Apr?s GdS 15' post-MRA Pmotrice [10-15] cmH2O",
                    apresGdS15_postMRA_Pmotrice_sup15cmH2O = "Apr?s GdS 15' post-MRA Pmotrice >15 cmH2O",
                    arretMERP = "Arr?t de la MERP",
                    arretMRA = "Arr?t de la MRA",
                    PEEPMAX = "PEEP MAX",
                    ...
                    ACR = "ACR",
                    hypotension_arterielle = "Hypotension arterielle",
                    ...
                    sortiehosp_vivant01 = "Duree sejour USI (j)",
                    sejourpostrea_j = "Sortie Hospit Vivant",
                    sejourtotal_j = "Date sortie Hospit",
                    vivant_j28 = "Vivant ? J28",
                    dureeVM_j = "Duree VM (j)",
                    jourssansVM_sur28j = "Soit nbr jour sans VM (/28j)",
                    dureeP_F_inf200j = "Duree P/F<200 (j)",
                    jourscurarises = "Nb jours curarises",
                    curarisation_infegal48h = "Curarisation < ou = 48h",
                    necessiteNO = "Necessite NO",
                    jourssousNO = "Nbr jours sous NO",
                    necessiteAlmitrine = "Necessite Almitrine",
                    necessiteECMO = "Necessite ECMO",
...
plot.roc(roc.23 , legacy.axes = TRUE, identity = F, col = "red", lwd = 1,
         print.auc=TRUE, auc.polygon=T, auc.polygon.col=rgb(.0,0.5,.0,0.1),
...
par(xpd = TRUE)
segments(1, 0, 0, 1)
plot(smooth(roc.23), add=T, col="black", lwd = 0.8)

# plot 2023 second var----------------------------------------------------------


y = la$Delta_P_F_sup20
str(la$R_I_ratio)
la$R_I_ratio = as.numeric(as.character(la$R_I_ratio))
x = la$R_I_ratio
...
la$y = la$Delta_P_F_sup20
la$x = la$Vrec_VteaPEEP15

rocplot <- ggplot(la, aes(m = x, d = y))+ geom_roc(n.cuts=20,labels=FALSE)
...
# with as continous variable Vvrec_pour_cent
...
y = as.factor(la$Delta_P_F_sup20)
x = as.numeric(as.character(la$Vvrec_pour_cent))

la$Vvrec_pour_cent = as.numeric(as.character(la$Vvrec_pour_cent))
la$Delta_P_F_sup20 = as.factor(la$Delta_P_F_sup20)

roc.sup20 <- roc(la$Delta_P_F_sup20, la$Vvrec_pour_cent)
...
la$jourssousECMO = as.numeric(as.character(la$jourssousECMO)) 
la$dureeUSI_j = as.numeric(as.character(la$dureeUSI_j))
la$sejourpostrea_j = as.numeric(as.character(la$sejourpostrea_j))
la$sejourtotal_j = as.numeric(as.character(la$sejourtotal_j))
la$dureeVM_j = as.numeric(as.character(la$dureeVM_j))
...
la$BestPEEP_soitPmotrice = as.numeric(as.character(la$BestPEEP_soitPmotrice))
la$T0_A_FiO2 = as.numeric(as.character(la$T0_A_FiO2))
la$FEVG_pourc = as.numeric(as.character(la$FEVG_pourc))
la$T0_FiO2 = as.numeric(as.character(la$T0_FiO2))
la$NO_ppm = as.numeric(as.character(la$NO_ppm))
la$seancesDV_avantinclusion = as.numeric(as.character(la$seancesDV_avantinclusion))
la$seancesDV = as.numeric(as.character(la$seancesDV))
la$Vvrec_pour_cent = as.numeric(as.character(la$Vvrec_pour_cent))
...
variables = c("Age", "Homme", "Taille", "Poids", "IMC",  
              ...
              "FDR_SDRA_inhalation", "FDR_SDRA_pancreatiteaigue", "FDR_SDRA_peritonite", 
              "FDR_SDRA_ischemiedigestive", "FDR_SDRA_traumatisegrave", "FDR_SDRA_transfusionmassive", 
...
variables7 = c("arretMERP", "arretMRA", 
              ...
              "P_F_inf_100", "P_F_100_200", "P_F_sup_300", "Vvrec_pour_cent")

categorical = c( "Homme", "delai_covidsympt_inclusion", "delai_COVID_Inclusion", "delai_COVID_Inclusion7j", 
                 "delai_COVID_Inclusion7j14j", "delai_COVID_Inclusion14j",
                "seancesDV_avantinclusion", "etiologieSDRApulmonaire", "covid01", 
               "FDR_SDRA_pneumopathie", 
                "FDR_SDRA_sepsis", "FDR_SDRA_choc", "FDR_SDRA_contusionspulm", 
                "FDR_SDRA_inhalation", "FDR_SDRA_pancreatiteaigue", "FDR_SDRA_peritonite", 
                "FDR_SDRA_ischemiedigestive", "FDR_SDRA_traumatisegrave", "FDR_SDRA_transfusionmassive", 
...
categorical2 = c("sufenta01", "cisatracurium01", 
                ...
                "dobutamine01", "NO01", "NOinf5", "NO_5_10", "NO_sup10", 
...
categorical3 = c("SpO2_sup96p100", "SpO2_92_96", "SpO2_inf92", "ETT_faite", 
                "FEVG_sup50", "FEVG_30_50", "FEVG_inf30", "PRVG_elevees", "PRVG_basses", 
...
categorical7 = c("arretMERP", "arretMRA", 
                ...
                "P_F_inf_100", "P_F_100_200", "P_F_sup_300")
...
table(la$necessiteNO)
la$necessiteNO = as.factor(la$necessiteNO)
table(la$necessiteNO)

tabnec = table(la$necessiteNO, la$Delta_P_F_sup20)
prop.table(tabnec, margin = 2)

chisq.test(tabnec, correct = FALSE)

# Vrec_VteaPEEP15 
table(la$Vrec_VteaPEEP15)
la$Vrec_VteaPEEP15 = as.numeric(as.character(la$Vrec_VteaPEEP15))
mean(la$Vrec_VteaPEEP15, na.rm = TRUE)
sd(la$Vrec_VteaPEEP15, na.rm = TRUE)

library(dplyr)
la %>%
  group_by(Delta_P_F_sup20) %>%
  summarise_at("Vrec_VteaPEEP15", mean, na.rm = TRUE)

aggregate(la$Vrec_VteaPEEP15, list(la$Delta_P_F_sup20), FUN=mean) 
aggregate(la$Vrec_VteaPEEP15, list(la$Delta_P_F_sup20), FUN=sd) 

t.test(la$Vrec_VteaPEEP15, la$Delta_P_F_sup20, conf.level = 0.95)
...
la$dcmh2o = as.numeric(as.character(la$T0_PEEP_cmH2O)) - 
  as.numeric(as.character(la$apresGdS15_postMRA_PEEP_cmH2O))
...
# PEEP increased
table(la$dcmh2o)
la$dcmh2o_incr[la$dcmh2o>0] <- "1"
la$dcmh2o_incr[la$dcmh2o<=0] <- "0"
table(la$dcmh2o_incr)
as.factor(la$dcmh2o_incr)

table(la$dcmh2o_incr, la$Delta_P_F_sup20)


# (T0_Pplat_cmH2O) - (apresGdS15_postMRA_PplatcmH2O)

la$dpplat = as.numeric(as.character(la$T0_Pplat_cmH2O)) - 
  as.numeric(as.character(la$apresGdS15_postMRA_PplatcmH2O))
...
la$motrice = as.numeric(as.character(la$T0_Pmotrice_cmH2O)) - 
  as.numeric(as.character(la$apresGdS15_postMRA_PmotricecmH2O))
...
la$compliance = as.numeric(as.character(la$T0_Compliance_mlcmH2O)) - 
  as.numeric(as.character(la$apresGdS15_postMRA_Compliance_mlcmH2O))
